...
class CircularProgressBar(Gtk.DrawingArea, Widget):
    @GObject.GObject.Property(float, "read-write", default_value=0.0)
    ...
    @GObject.Property(float, "read-write", default_value=1.0)
    ...
    @GObject.Property(bool, "read-write", default_value=False)
    def pie(self) -> bool:
        return self._pie
    ...
    @GObject.Property(int, "read-write", default_value=4)
    ...
    @GObject.Property(object, "read-write")
    ...
    # @GObject.Property(int, "read-write")
    # def angle(self) -> int:
    #     return self._angle
